...
namespace BrodUITests.HelpersTests
{
    public class Brush2DtoColorDictTests
    {
        ...
        public void BrushToDictTest()
        {
            ...
            Dictionary<int, GenericVector> expected = new();
            ...
            val4.Add(0);
            expected.Add(3, val4);
            Dictionary<int, GenericVector> actual = Brush2DtoColorDict.BrushToDict(start);
        ...
        public void DictToBrushTest()
        {
            ...
            Dictionary<int, GenericVector> data = new();
